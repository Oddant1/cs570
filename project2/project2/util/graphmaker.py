...
class GraphMaker:
    ...
    def __init__(self,nodeCount=10):
        ...
        self.expansion=200  # how wide the graph will be. Basically a factor that increases the x-y extents of plane
        ...
        self.buildGraph()  # Build the new graph!
